...
import com.chekh.repository.PassportRepository;
...
public class PassportController implements Controller<PassportEntity> {
    public static final String SORT_PROPERTY = "fullName";
    ...
    @GetMapping("/all")
    public Response<List<PassportEntity>> getAll(
    ...
    @GetMapping
    public Response<PassportEntity> get(@RequestParam(value = "id") Long id) {
        try {
    ...
    @PostMapping("/add")
    public SimpleResponse add(@RequestBody Request<PassportEntity> request) {
        try {
    ...
    @PostMapping("/update")
    public SimpleResponse update(@RequestBody Request<PassportEntity> request) {
        try {
            repository.save(request.getData());
            return new SimpleResponse(Response.Status.SUCCESS.getCode());
        } catch (Exception e) {
