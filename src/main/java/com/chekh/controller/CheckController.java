...
import com.chekh.repository.CheckRepository;
...
public class CheckController implements Controller<CheckEntity> {
    ...
    @GetMapping("/all")
    public Response<List<CheckEntity>> getAll(
    ...
    @GetMapping
    public Response<CheckEntity> get(@RequestParam(value = "id") Long id) {
        try {
    ...
    @PostMapping("/add")
    public SimpleResponse add(@RequestBody Request<CheckEntity> request) {
        try {
    ...
    @PostMapping("/update")
    public SimpleResponse update(@RequestBody Request<CheckEntity> request) {
        try {
            repository.save(request.getData());
            return new SimpleResponse(Response.Status.SUCCESS.getCode());
        } catch (Exception e) {
